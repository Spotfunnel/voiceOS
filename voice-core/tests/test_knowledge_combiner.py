...
def test_combine_prompts_layer1_only():
    ...
    combined = combine_prompts(None, None)
    assert "VOICE BASICS" in combined
...
def test_combine_prompts_no_knowledge():
    ...
    combined = combine_prompts("", layer2)
...
def test_combine_prompts_no_layer2():
    ...
    combined = combine_prompts(knowledge, None)
...
def test_combine_prompts_order():
    ...
    idx_layer1 = combined.index("VOICE BASICS")
    idx_knowledge = combined.index("COMPANY KNOWLEDGE BASE")
    idx_layer2 = combined.index("YOUR ROLE & PURPOSE")
...
def test_combine_prompts_knowledge_header():
    ...
    combined = combine_prompts("Info", "Layer2")

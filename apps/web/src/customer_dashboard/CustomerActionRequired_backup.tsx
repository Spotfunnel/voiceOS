        ...
        <div className="space-y-6 sm:space-y-8 animate-in fade-in duration-500 pb-24 sm:pb-16">
            ...
            <div className="space-y-6 sm:space-y-10">
                {actionItems.length === 0 ? (
                    <Card className="border-border bg-card/50 backdrop-blur-sm rounded-xl">
                                ...
                                <div key={item.id} className="flex flex-col">
                                    <div
                                        className={`
                                            ...
                                            ${selectedIds.has(item.id) ? 'border-primary ring-1 ring-primary/20 bg-primary/5' : 'border-border hover:border-primary/50'}
                                    ...
                                    {/* Expanded View */}
                                    {expandedId === item.id && (
                                        <div className="bg-white border-x border-b border-border/60 rounded-b-[2rem] p-6 sm:p-12 space-y-8 animate-in slide-in-from-top-4 duration-300 shadow-xl overflow-hidden">

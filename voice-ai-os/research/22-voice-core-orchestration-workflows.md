# Research: Voice Core, Orchestration & Workflow Separation

**🔴 ARCHITECTURAL LAW - NON-NEGOTIABLE**

This research defines the mandatory three-layer separation that enables:
- 2,000+ companies on one platform
- <1 hour onboarding (vs 10-40 hours with prompt-centric platforms)
- Zero per-customer prompt engineering
- Immutable voice core across all customers
...
- Configuration UI: Drag-and-drop objective graph builder
